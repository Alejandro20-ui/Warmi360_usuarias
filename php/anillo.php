            ...
            <div class="p-4 custom-bg-info rounded shadow-lg">
                ...
                <form id="form-pago">
                    <div class="mb-3">
                        ...
                        <input type="text" id="nombre" class="form-control" value="<?= htmlspecialchars($nombreCompleto) ?>" readonly>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn custom-btn-purple btn-generar-pago" data-metodo="yape">Generar Pago</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="modalPlin" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn custom-btn-purple btn-generar-pago" data-metodo="plin">Generar Pago</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="modalTarjeta" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn custom-btn-purple btn-generar-pago" data-metodo="tarjeta">Generar Pago</button>
            </div>
        </div>
    </div>
</div>
